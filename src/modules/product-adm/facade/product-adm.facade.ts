...
import { InputCheckStockDto, OutputCheckStockDto } from "../usecase/check-stock/check-stock.dto";
...
export interface UseCaseProps {
    ...
    checkStockUseCase?: UseCaseInterface<InputCheckStockDto, OutputCheckStockDto>;
}
...
export default class ProductAdmFacade implements ProductAdmFacadeInterface {
    ...
    private _checkStockUseCase: UseCaseInterface<InputCheckStockDto, OutputCheckStockDto>;
